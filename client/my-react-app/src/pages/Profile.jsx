          ...
          <div className="h-full flex flex-col justify-around">
            ...
            <div className="flex  w-full h-2/5 p-3">
              <div className="flex items-end flex-col justify-around ">
                ...
                <h2 className="text-roboto text-base-100 text-xl"> First name : </h2>
              ...
              <div className="text-primary flex flex-col justify-around">
                ...
                <h2 className="text-roboto text-xl text-neutral">{user.first_name}</h2>
                <h2 className="text-roboto text-xl text-neutral">{user.email}</h2>
                <p className="text-roboto text-xl text-neutral">{user.role}</p>
                <p className="text-roboto text-xl text-neutral">{user.last_login}</p>
